...
{
    public List<byte[]> CachedMessages = new List<byte[]>();
    public List<byte[]> thingsThatFailedToHandle= new List<byte[]>();

    public List<byte[]> retryQueueForThingsThatFailedToHandle= new List<byte[]>();
    public List<byte[]> thingsThatFailedToSend= new List<byte[]>();
     public List<byte[]> retryQueueForThingsThatFailedToSend= new List<byte[]>();

     public string someDataYouWantToUpdatePeriodically;
