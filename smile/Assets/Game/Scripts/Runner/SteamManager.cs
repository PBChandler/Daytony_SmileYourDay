...
//
    ...
    public string isRankedDataString;
    public string TRUE = "true", playerEloDataString = "wood 1";
    ...
    // void RelaySocketMessageReceived(IntPtr data, int size, uint id)
    // {
